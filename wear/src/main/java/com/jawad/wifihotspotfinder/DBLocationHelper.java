...
// This class handles the database that contains the data
// for all the locations in Greater London with free Wi-Fi Hotspot.
public class DBLocationHelper extends SQLiteOpenHelper {
    ...
    private final static String DB_NAME = "wifi_hotspots.db";
    public final static String DB_DIRECTORY = DB_PATH + DB_NAME;
    public final static String DB_TABLE = "wifi_locations";
    ...
    private final String TAG = "DBLocationHelper";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String oldVers = String.valueOf(oldVersion);
        String newVers = String.valueOf(newVersion);
